...
public class CF_TC01_Validate_search_results_for_healthcare_policies3 extends Base {
	// Declaraing
	...
	public void validateTestPlansFromTextAndBanners() throws InterruptedException, IOException {
		...
		soft.assertEquals(textResult, bannerResult,"Text results are matching with Banner results, TC is failed");
		Reporter.log("TC is passed ", true);
		//Utility.takeScreenShot(driver, "TC01_");
		soft.assertTrue(result.sortPlanElementPresency(),"Sort Plan Field not present");
		Reporter.log("TC is passed ", true);
		soft.assertAll();
